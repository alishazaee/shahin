...
public class KafkaUtils  {
    ...
    public static KafkaProducer<Long, String> createProducer(String clientId, KafkaConfig kafkaProducerConfig) {
        ...
        producerConfigs.put("key.serializer", "org.apache.kafka.common.serialization.LongSerializer");
